...
<img src="/img/jinjie/android界面性能调优/1.jpg" />

如果你的应用没有在 16ms 内完成这一帧的绘制，假设你花了 24ms 来绘制这一帧，那么就会出现掉帧的情况。

<img src="/img/jinjie/android界面性能调优/2.jpg" />
...
<img src="/img/jinjie/android界面性能调优/3.jpg" />
...
想了解更多详细的 ART 和 Dalvik 虚拟机垃圾回收机制，可「 [戳我](http://blog.csdn.net/luoshengyang/article/details/42072975) 」和「 [我](http://blog.csdn.net/luoshengyang/article/details/41338251) 」进行深入了解。
...
<img src="/img/jinjie/android界面性能调优/4.jpg" />
...
<img src="/img/jinjie/android界面性能调优/8.jpg" />

Hierarchy View 在Android SDK里自带，常用来查看界面的视图结构是否过于复杂，用于了解哪些视图过度绘制，又该如何进行改进。详见官方使用教程（需要翻墙）:「 [戳我](http://developer.android.com/tools/performance/hierarchy-viewer/index.html) 」，官方介绍「 [戳我](https://www.youtube.com/watch?v=URyoiAt8098) 」。
...
更多 Lint 的官方介绍「 [戳我](https://www.youtube.com/watch?v=URyoiAt8098) 」。

- Systrace

<img src="/img/jinjie/android界面性能调优/9.jpg" />

Systrace 在Android DDMS 里自带，可以用来跟踪 graphics 、view 和 window 的信息，发现一些深层次的问题。很麻烦，限制大，实际调试中我基本用不到。官方介绍 「[戳我](http://developer.android.com/tools/help/systrace.html)」。

- Track

<img src="/img/jinjie/android界面性能调优/10.jpg" />
...
<img src="/img/jinjie/android界面性能调优/11.jpg" />
...
<img src="/img/jinjie/android界面性能调优/12.jpg" />
...
<img src="/img/jinjie/android界面性能调优/13.jpg" />
...
<img src="/img/jinjie/android界面性能调优/14.jpg" />
...
<img src="/img/jinjie/android界面性能调优/17.jpg" />
...
<img src="/img/jinjie/android界面性能调优/18.jpg" />
...
<img src="/img/jinjie/android界面性能调优/19.jpg" />
...
<img src="/img/jinjie/android界面性能调优/20.jpg" />
...
<img src="/img/jinjie/android界面性能调优/21.jpg" />
...
本文摘选自 androidtest.org 《Android界面性能调优手册》
