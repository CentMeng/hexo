...
public class ConfigConstants {
    ...
    private static final int MAX_HEAP_SIZE = (int) Runtime.getRuntime().freeMemory();//分配的可用内存
    ...
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "smallpic";//小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "pic";//默认图所放路径的文件夹名
